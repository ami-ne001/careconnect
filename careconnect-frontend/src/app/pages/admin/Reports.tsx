    ...
    <div>
        ...
        {[
          ...
          <div key={r.title} className="bg-white rounded-xl p-5 border border-[#E2E8F0]" style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
            ...
            <button
              type="button"
              disabled
              className="w-full h-9 rounded-lg bg-[#1E3A5F] text-white text-sm font-medium opacity-50 cursor-not-allowed"
            >
              Generate Report
            </button>
          </div>
      ...
      <div className="bg-white rounded-xl border border-[#E2E8F0]" style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
        <div className="px-5 py-4 border-b border-[#E2E8F0]">
          ...
          <p className="text-xs text-[#64748B] mt-0.5">Exported PDF/CSV reports will appear here</p>
        </div>
        <div className="px-5 py-12 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xs text-[#64748B] mt-1 max-w-sm">
            Report export is not implemented yet. Charts above use live data from billing, admissions, and staff records.
          </p>
        </div>
      </div>
    </div>
